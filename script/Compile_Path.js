...
/*
	...
	*/
	...
	ReadValuePath(id_6,var_6,id_2);
	ReadValuePath(id_7,var_7,id_2);
	ReadValuePath(id_8,var_8,id_2);
	ReadValuePath(id_9,var_9,id_2);
	ReadValuePath(id_10,var_10,id_2);
	ReadValuePath(id_11,var_11,id_2);
	ReadValuePath(id_12,var_12,id_2);
	ReadValuePath(id_13,var_13,id_2);
	ReadValuePath(id_14,var_14,id_2);
	ReadValuePath(id_15,var_15,id_2);
	ReadValuePath(id_16,var_16,id_2);
	ReadValuePath(id_17,var_17,id_2);
	ReadValuePath(id_18,var_18,id_2);
	ReadValuePath(id_19,var_19,id_2);
	ReadValuePath(id_20,var_20,id_2);
	ReadValuePath(id_21,var_21,id_2);
	ReadValuePath(id_22,var_22,id_2);
...
var var_4=["unit/dHdGlobal.gsHMIdata.sSegPt[0].y1","unit/dHdGlobal.gsHMIdata.sSegPt[1].y1","unit/dHdGlobal.gsHMIdata.sSegPt[2].y1","unit/dHdGlobal.gsHMIdata.sSegPt[3].y1","unit/dHdGlobal.gsHMIdata.sSegPt[4].y1","unit/dHdGlobal.gsHMIdata.sSegPt[5].y1","unit/dHdGlobal.gsHMIdata.sSegPt[6].y1","unit/dHdGlobal.gsHMIdata.sSegPt[7].y1","unit/dHdGlobal.gsHMIdata.sSegPt[8].y1","unit/dHdGlobal.gsHMIdata.sSegPt[9].y1","unit/dHdGlobal.gsHMIdata.sSegPt[10].y1","unit/dHdGlobal.gsHMIdata.sSegPt[11].y1","unit/dHdGlobal.gsHMIdata.sSegPt[12].y1","unit/dHdGlobal.gsHMIdata.sSegPt[13].y1","unit/dHdGlobal.gsHMIdata.sSegPt[14].y1","unit/dHdGlobal.gsHMIdata.sSegPt[15].y1","unit/dHdGlobal.gsHMIdata.sSegPt[16].y1","unit/dHdGlobal.gsHMIdata.sSegPt[17].y1","unit/dHdGlobal.gsHMIdata.sSegPt[18].y1","unit/dHdGlobal.gsHMIdata.sSegPt[19].y1"];
...
*/
var id_02=["inp_212","inp_222","inp_232","inp_242","inp_252","inp_262","inp_272","inp_282","inp_292","inp_302","inp_312","inp_322","inp_332","inp_342","inp_352","inp_362","inp_372","inp_382","inp_392","inp_402"];
