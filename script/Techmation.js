...
function BtnDown(id)
{
	...
	{
		//document.getElementById(id).style.background="url(../image/bg_BtnDown_16335.png)";
	}
	else if(id == "btn_Start")
	{
		document.getElementById(id).style.background="url(../image/bg_StartDown.png)";
		writeValueFN("true", "unit/dHdGlobal.gboStartProgram");
	}
	else if(id == "btn_Continue")
	{
		document.getElementById(id).style.background="url(../image/bg_ContinueDown.png)";
		writeValueFN("true", "unit/dHdGlobal.gboContinueProgram");
	}
	else if(id == "btn_Stop2")
	{
		document.getElementById(id).style.background="url(../image/bg_StopDown.png)";
...
function BtnUp(id)
{
	...
	{
		//document.getElementById(id).style.background="url(../image/bg_BtnUp_16335.png)";
	}
	else if(id == "btn_Start")
	{
		document.getElementById(id).style.background="url(../image/bg_StartUp.png)";
		writeValueFN("false", "unit/dHdGlobal.gboStartProgram");
	}
	else if(id == "btn_Continue")
	{
		document.getElementById(id).style.background="url(../image/bg_ContinueUp.png)";
		writeValueFN("false", "unit/dHdGlobal.gboContinueProgram");
	}
	else if(id == "btn_Stop2")
	{
		document.getElementById(id).style.background="url(../image/bg_StopUp.png)";
...
//姿态
  ...
  //模式1
	...
	SubscriptionData.ItemList[SubscriptionData.LastIndex] = new Object();
    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "techmationhtm機械手btn";  
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gboPickerIMMbreak";
    SubscriptionData.LastIndex = SubscriptionData.LastIndex + 1;
