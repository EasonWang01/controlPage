...
//姿态
  ...
  //模式1
    ...
    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "Areaset_forbidcheckuse";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gsHMIdata.sBlockedZone1.boUse";
